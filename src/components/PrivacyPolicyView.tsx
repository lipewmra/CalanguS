...
Última atualização: Setembro de 2026 (Versão 3.0)
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="text-xs bg-gradient-to-r from-amber-500/20 to-yellow-500/20 text-amber-600 dark:text-amber-300 font-mono font-black px-2.5 py-0.5 rounded-full border border-amber-500/40 shadow-xs">
                    CalanguS v3.8
                  </span>
                </div>
